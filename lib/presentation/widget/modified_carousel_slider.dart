...
typedef ModifiedCarouselSliderTopStackWidgetBuilder = Widget Function(BuildContext context, PageController pageController);

class ModifiedCarouselSlider extends StatefulWidget {
  ...
  final ModifiedCarouselSliderTopStackWidgetBuilder? modifiedCarouselSliderTopStackWidgetBuilder;

  ModifiedCarouselSlider({
    required this.items,
    required this.options,
    required this.modifiedCarouselSliderTopStackWidgetBuilder,
  ...
  ModifiedCarouselSliderState createState() => ModifiedCarouselSliderState(_carouselController);
}

class ModifiedCarouselSliderState extends State<ModifiedCarouselSlider> with TickerProviderStateMixin {
  ...
  ModifiedCarouselSliderState(this.carouselController);
  ...
  @override
  void didUpdateWidget(ModifiedCarouselSlider oldWidget) {
    ...
    return AspectRatio(
      ...
      child: Stack(
        children: [
          ...
          if (widget.modifiedCarouselSliderTopStackWidgetBuilder != null && pageController != null)
            widget.modifiedCarouselSliderTopStackWidgetBuilder!(context, pageController!)
        ]
      )
    );
  }
