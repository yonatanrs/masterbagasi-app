...
class ModifiedCanvasTouchDetector extends StatefulWidget {
  final CustomTouchPaintBuilder builder;
  final List<GestureType> gesturesToOverride;

  const ModifiedCanvasTouchDetector({
    Key? key,
  ...
  @override
  _ModifiedCanvasTouchDetectorState createState() => _ModifiedCanvasTouchDetectorState();
}

class _ModifiedCanvasTouchDetectorState extends State<ModifiedCanvasTouchDetector> {
